...
export default function OrganizationHierarchyEnhanced({ data, canEdit }: OrganizationHierarchyProps) {
  ...
  // Cards view for all organizational levels
  const renderCardsView = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {filteredData.companies.map(company => {
        ...
        return (
          <div key={`company-${company.company_id}`} className="bg-white rounded-lg shadow-md border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-200">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-2">
                <i className="fas fa-building-flag text-alliance-blue"></i>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <p><strong>Divisions:</strong> {divisions.length}</p>
            ...
            <div className="flex justify-end space-x-2 pt-3 border-t border-gray-100 mt-3">
              <Link href={`/organization/companies/${company.company_id}`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                View
              </Link>
              {canEdit && (
                <Link href={`/organization/companies/${company.company_id}/edit`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                  Edit
                </Link>
              )}
            </div>
      ...
      {/* Divisions */}
      {filteredData.divisions.map(division => (
        <div key={`division-${division.division_id}`} className="bg-white rounded-lg shadow-md border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-200">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center space-x-2">
              <i className="fas fa-building-user text-alliance-blue"></i>
          ...
          <div className="space-y-2 text-sm text-gray-600">
            <p><strong>Type:</strong> Division</p>
            {division.code && <p><strong>Code:</strong> {division.code}</p>}
            {division.director && <p><strong>Director:</strong> {division.director.first_name} {division.director.last_name}</p>}
          </div>
          <div className="flex justify-end space-x-2 pt-3 border-t border-gray-100 mt-3">
            <Link href={`/organization/divisions/${division.division_id}`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
              View
            </Link>
            {canEdit && (
              <Link href={`/organization/divisions/${division.division_id}/edit`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                Edit
              </Link>
            )}
          </div>
      ...
      {filteredData.regions.map(region => {
        ...
        return (
          <div key={`region-${region.region_id}`} className="bg-white rounded-lg shadow-md border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-200">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-2">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p><strong>Type:</strong> Region</p>
              <p><strong>Markets:</strong> {markets.length}</p>
              {(region.director || region.manager) && (
                <p><strong>Manager:</strong> {region.director?.first_name || region.manager?.first_name} {region.director?.last_name || region.manager?.last_name}</p>
              )}
            </div>
            <div className="flex justify-end space-x-2 pt-3 border-t border-gray-100 mt-3">
              <Link href={`/organization/regions/${region.region_id}`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                View
              </Link>
              {canEdit && (
                <Link href={`/organization/regions/${region.region_id}/edit`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                  Edit
                </Link>
              )}
            </div>
      ...
      {/* Markets */}
      {filteredData.markets.map(market => {
        const districts = districtsByMarket[market.market_id] || []
        return (
          <div key={`market-${market.market_id}`} className="bg-white rounded-lg shadow-md border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-200">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-2">
              ...
              <span className={`inline-flex rounded-full px-2 py-1 text-xs font-semibold ${
                market.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
              }`}>
                {market.is_active ? 'Active' : 'Inactive'}
              </span>
            </div>
            <div className="space-y-2 text-sm text-gray-600">
              <p><strong>Type:</strong> Market</p>
              <p><strong>Districts:</strong> {districts.length}</p>
              {market.manager && <p><strong>Manager:</strong> {market.manager.first_name} {market.manager.last_name}</p>}
            </div>
            <div className="flex justify-end space-x-2 pt-3 border-t border-gray-100 mt-3">
              <Link href={`/organization/markets/${market.market_id}`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                View
              </Link>
              {canEdit && (
                <Link href={`/organization/markets/${market.market_id}/edit`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                  Edit
                </Link>
              )}
            </div>
      ...
      {filteredData.districts.map(district => {
        ...
        return (
          <div key={`district-${district.district_id}`} className="bg-white rounded-lg shadow-md border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-200">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-2">
                <i className="fas fa-map-pin text-alliance-blue"></i>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p><strong>Type:</strong> District</p>
              <p><strong>Locations:</strong> {locations.length}</p>
              {district.manager && <p><strong>Manager:</strong> {district.manager.first_name} {district.manager.last_name}</p>}
            </div>
            <div className="flex justify-end space-x-2 pt-3 border-t border-gray-100 mt-3">
              <Link href={`/organization/districts/${district.district_id}`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                View
              </Link>
              {canEdit && (
                <Link href={`/organization/districts/${district.district_id}/edit`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                  Edit
                </Link>
              )}
            </div>
      ...
      {filteredData.locations.map(location => (
        <div key={`location-${location.location_id}`} className="bg-white rounded-lg shadow-md border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-200">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center space-x-2">
              <i className="fas fa-building text-alliance-blue"></i>
          ...
          <div className="space-y-2 text-sm text-gray-600">
            ...
            {location.store_number && <p><strong>Store #:</strong> {location.store_number}</p>}
            {location.manager && <p><strong>Manager:</strong> {location.manager.first_name} {location.manager.last_name}</p>}
          </div>
          <div className="flex justify-end space-x-2 pt-3 border-t border-gray-100 mt-3">
            <Link href={`/locations/${location.location_id}`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
              View
            </Link>
            {canEdit && (
              <Link href={`/locations/${location.location_id}/edit`} className="text-alliance-navy hover:text-alliance-navy-dark text-sm">
                Edit
              </Link>
            )}
          </div>
      ...
      <div className="bg-white shadow rounded-lg px-4 py-4">
        <div className="space-y-4">
          ...
          <div>
            <input
              type="text"
              placeholder="Search organizations by name, manager, or any visible information..."
              value={searchTerm}
          ...
          <div className="text-sm text-gray-600">
            {filteredData.companies.length} companies, {filteredData.divisions.length} divisions, {filteredData.regions.length} regions, {filteredData.markets.length} markets, {filteredData.districts.length} districts, {filteredData.locations.length} locations
            {searchTerm && (
              <span className="ml-2 text-alliance-blue font-medium">
              ...
              {filteredData.companies.map(company => {
                ...
                return (
                  <div key={company.company_id} className="border rounded-lg">
                    <div 
                      className="px-4 py-3 bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors duration-200"
                      onClick={() => toggleCompany(company.company_id)}
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <i className={`fas fa-chevron-${isExpanded ? 'down' : 'right'} text-gray-400 transition-transform duration-200`}></i>
                          <i className="fas fa-building-flag text-alliance-blue"></i>
                        ...
                        {divisions.map(division => {
                          ...
                          return (
                            <div key={division.division_id} className="ml-6 border-l-2 border-gray-200 pl-4">
                              <div 
                                className="cursor-pointer hover:bg-gray-50 py-2 transition-colors duration-200"
                                onClick={() => toggleDivision(division.division_id)}
                              >
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center space-x-3">
                                    <i className={`fas fa-chevron-${isDivExpanded ? 'down' : 'right'} text-gray-400 transition-transform duration-200`}></i>
                                    <i className="fas fa-building-user text-alliance-blue"></i>
                                    ...
                                    return (
                                      <div key={region.region_id} className="border-l-2 border-gray-200 pl-4">
                                        ...
                                        >
                                          <div className="flex items-center justify-between">
                                            <div className="flex items-center space-x-3">
                                              <i className={`fas fa-chevron-${isRegExpanded ? 'down' : 'right'} text-gray-400 transition-transform duration-200`}></i>
                                              <i className="fas fa-map text-alliance-blue"></i>
                                              ...
                                              return (
                                                <div key={market.market_id} className="border-l-2 border-gray-200 pl-4">
                                                  ...
                                                  >
                                                    <div className="flex items-center justify-between">
                                                      <div className="flex items-center space-x-3">
                                                        <i className={`fas fa-chevron-${isMarketExpanded ? 'down' : 'right'} text-gray-400 transition-transform duration-200`}></i>
                                                        <i className="fas fa-store text-alliance-blue"></i>
                                                  ...
                                                  {isMarketExpanded && districts.length > 0 && (
                                                    <div className="ml-6 space-y-2">
                                                      {districts.map(district => {
                                                        const locations = locationsByDistrict[district.district_id] || []
                                                        const isDistrictExpanded = expandedDistricts.has(district.district_id)
                                                        ...
                                                        return (
                                                          <div key={district.district_id} className="border-l-2 border-gray-200 pl-4">
                                                            ...
                                                            >
                                                              <div className="flex items-center justify-between">
                                                                <div className="flex items-center space-x-3">
                                                                  <i className={`fas fa-chevron-${isDistrictExpanded ? 'down' : 'right'} text-gray-400 transition-transform duration-200`}></i>
                                                                  <i className="fas fa-map-pin text-alliance-blue"></i>
                                                            ...
                                                            {isDistrictExpanded && locations.length > 0 && (
                                                              <div className="ml-6 space-y-1">
                                                                {locations.map(location => (
                                                                  <div key={location.location_id} className="flex items-center justify-between py-1 px-2 hover:bg-gray-50 transition-colors duration-200">
                                                                    <div className="flex items-center space-x-3">
                                                                      <i className="fas fa-building text-alliance-blue"></i>
